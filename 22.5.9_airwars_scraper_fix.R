...
##### NOTE FROM 22.5.9 APPLICABLE TO LINE 24 -> the series of numbers below (e.g. 2:32) is referent to the series of urls for a search
...
##### has a /32/ pasted into the url (and every number in between pasted into other obersvations for the pages in between).
##### Since this series of pages is different from the last series of urls (without declared strick), the sequence was changed from 1:45 to 2:32
